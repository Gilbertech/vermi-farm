  ...
  const mockStatements: Statement[] = [
    {
      ...
      file_path: '/statements/statement-1.pdf',
    ...
    },
    {
      ...
      group_id: '1',
      statement_type: 'monthly',
      file_path: '/statements/statement-2.pdf',
    ...
    const loadStatements = async () => {
      try {
        ...
        try {
          ...
          console.warn('API statements failed, using mock data:', apiError);
  ...
  const handleDownload = async (statement: Statement) => {
    try {
      ...
      try {
        ...
        console.warn('API download failed, generating locally:', apiError);
    ...
    <div className="space-y-4 lg:space-y-6 p-4 lg:p-0">
      ...
      {loading && (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading statements...</p>
        </div>
      )}
      ...
      {error && (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 text-center">
          <p className="text-red-600 dark:text-red-400 mb-2">Error loading statements: {error}</p>
          <button 
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 lg:px-6 py-4 text-sm text-gray-900 dark:text-gray-100 font-medium">
                        {statement.group_id ? getGroupName(statement.group_id) : 'N/A'}
                      </td>
                      <td className="px-4 lg:px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
                        {statement.user_id ? getUserName(statement.user_id) : 'N/A'}
                      </td>
                      <td className="px-4 lg:px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
