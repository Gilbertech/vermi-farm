...
import { Menu, LogOut, User, Bell, Check, X, AlertTriangle, DollarSign, CreditCard, ArrowLeftRight, Settings, Shield, Activity, Download } from 'lucide-react';
...
const EnhancedTopNavbar: React.FC<EnhancedTopNavbarProps> = ({ title, onMenuClick }) => {
          ...
          <div className="flex items-center space-x-4">
            ...
            {currentUser?.role === 'super_admin' && (
              <div className="relative">
                ...
                {showNotifications && (
                  <div className="absolute right-0 mt-2 w-96 max-w-[90vw] bg-[#E7F4EA] rounded-lg shadow-xl border border-[#2D8E41] z-50 max-h-[80vh] overflow-hidden">
            ...
            {currentUser && (
              <div className="relative">
                ...
                >
                  <div className="w-8 h-8 bg-[#2d8e41] rounded-full flex items-center justify-center">
